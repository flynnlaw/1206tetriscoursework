 ...
 *
 * <p>The GamePiece class also contains a factory for producing a GamePiece of a particular shape,
 * as specified by it's number.
 */
public class GamePiece {
  ...
  private GamePiece(String name, int[][] blocks, int value) {
    ...
    // Use the shape of the block to create a grid with either 0 (empty) or the value of this shape
    // for each block.
  ...
  /** Rotate this piece exactly once by rotating it's 3x3 grid anticlockwise */
  public void rotate() {
  ...
  /** Rotate this piece exactly once by rotating it's 3x3 grid clockwise */
  public void rotateClockwise() {
    ...
    // Update the blocks with the rotated matrix
    blocks = rotated;
  }
