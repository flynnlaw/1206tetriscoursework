 ...
 * the aspect ratio.
 *
 * <p>Drawing will be scaled appropriately.
 *
 * <p>This takes the worry about the layout out and will allow the game to scale to any resolution
 * easily.
 *
 * <p>It uses the width and height given which should match the main window size. This will be the
 * base drawing resolution, but will be scaled up or down as the window is resized.
 *
 * <p>You should not need to modify this class
 */
